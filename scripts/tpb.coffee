...
ricky = [
  ...
  "Denial and Error...",
  "Make my words",
  "Hey Bubs, are you watching that documentary on Saskatchewans?",
  "(While addressing the Judge in court) Thank you, Your Majesty.",
  ...
  "(To Alex Lifeson of Rush) Well, play that Diane Sawyer song, then.",
  ...
  "These plates got me from Tuscany, Arizona to Kentville, Nova Scotia. - Ray, Ricky's Dad",
  ...
  "I don't need your cherry trees.",
  ...
  "(To Trevor and Cory) Well, I'd like for you two to come with us, but apparently it's clear to see who makes the pants here.",
  ...
  "If Randy thinks he's smartener than me, he's wrong.",
  ...
  "(To Shitty Bill) Take a shower for fuck's sake! You look like a fuckin' hobolo!",
  "(To Randy) Why don't you fuck off and go get some hypo-suction!",
